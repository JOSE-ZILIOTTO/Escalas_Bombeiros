    ...
    <div class="controles-escala">
        ...
        <div style="text-align: right;">
            ...
            <button id="theme-toggle" class="button-link btn-secondary" style="margin-left: 10px;" title="Alternar tema claro/escuro">
             ...
             <a class="button-link btn-secondary" href="index.php?logout=1">Sair</a>
        </div>
    </div>
...
(function () {
  ...
  btn.addEventListener('click', async () => {
    ...
    // usa o mês/ano atuais da página; troque para valores fixos se quiser
    const m = <?php echo (int)$mes_atual; ?>;
    const y = <?php echo (int)$ano_atual; ?>;

    try {
      // auto=1 sincroniza mês atual + próximo. Remova &auto=1 se quiser só o mês da tela.
      ...
      // sucesso básico: HTTP 200 e array com pelo menos um item ok=true
