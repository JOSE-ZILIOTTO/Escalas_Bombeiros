...
define('DB_USERNAME', 'if0_40078372'); // Usuário padrão do XAMPP
define('DB_PASSWORD', 'yubEh0KVpM');     // Senha padrão do XAMPP (vazia)
define('DB_NAME', 'if0_40078372_escala'); // Nome do seu banco de dados - CONFIRMADO
